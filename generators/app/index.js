...
module.exports = yeoman.extend({
    ...
    prompting: function () {
        ...
        if (!this.options['skip-install-message']) {
            this.log(yosay(
                'Welcome to the amazing ' + chalk.yellow('Ariane') + ' generator!'
            ));
        }
        ...
        var prompts = [{
...

            {
                ...
                message: 'Wich scripting language wuold you use ?',
                default: 'es', // ES6
                choices: [{
                    name: 'ES6',
                    value: 'es'
        ...
        this.prompt(prompts, function (answers) {
            ...
            this.useBabel = answers.scriptingLanguage == 'es';
    ...
    writing: {
        ...
        scripts: function () {
            if (this.useBabel) {
                this.fs.copy(
                    this.templatePath('scripts/ES6/main.js'),
                    this.destinationPath('app/scripts/main.js')
                );
                this.fs.copy(
                    this.templatePath('scripts/ES6/plugins.js'),
